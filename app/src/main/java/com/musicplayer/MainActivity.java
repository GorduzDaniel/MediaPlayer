...
public class MainActivity extends Activity implements android.app.LoaderManager.LoaderCallbacks<Cursor>, SongsAdapter.SongPlayedListener {
            ...
            case LOAD_SONGS_ID:
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    do {
                        ...
                        String mArtistId = cursor.getString(artistColumn);
                        ...
                        mSongs.add(new NewSong(mAlbumMediaId, mTitleId, mArtistId, mDurationId, mSongData));
                    }
    ...
    public void onPlayClicked(final int songPosition) {
        ...
        mService.setCurrentPosition(mCurrentSongPosition);
        ...
        mUpdateSeekBar = new Thread() {
            ...
            public void run() {
                ...
                int currentDurationPosition = 0;
                smallseekBar.setMax(totalDuration);
                while (currentDurationPosition <= totalDuration) {
                    currentDurationPosition = mService.getCurrentPosition();
                    smallseekBar.setProgress(currentDurationPosition);
                }
            }
        };
    ...
    public void setSmallPreviousClickListener() {
        ImageButton smallPrevious = (ImageButton) findViewById(R.id.small_previous);
